...
class AuthControllerIntegrationTest {
    ...
    void shouldLoginAndReturnJwtToken() throws Exception {
        ...
        // Teraz zaloguj
        LoginDto loginDto = new LoginDto(email, TEST_PASSWORD);
    ...
    void shouldReturn401WhenLoginNonExistentUser() throws Exception {
        LoginDto loginDto = new LoginDto("nonexistent@example.com", "AnyPassword123");
    ...
    void shouldReturn409WhenRegisterWithDuplicateEmail() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/register")
                ...
                .andExpect(jsonPath("$.error").value(containsString("juz istnieje")));
    }
